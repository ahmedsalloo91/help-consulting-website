...
export function IndustryCard({ title, description, icon: Icon }: IndustryCardProps) {
  return (
    <article className="premium-card flex min-h-44 gap-4 p-5 sm:p-6">
      <div className="hex-clip grid h-12 w-12 shrink-0 place-items-center bg-navy text-white shadow-[0_14px_24px_rgba(7,27,58,0.18)]">
